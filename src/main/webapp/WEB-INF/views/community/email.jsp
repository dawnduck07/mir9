		            ...
		            <div class="box-body">
		                ...
		                <form name="form_register" method="post" action="${pageContext.request.contextPath}/comm/email?${_csrf.parameterName}=${_csrf.token}">
			                ...
			                <div style="text-align:right;">
			                	<!-- 언어 설정 : 적용 안 됨 -->
								<button type="button" id="locale_ko" onclick="parent.location.href='${pageContext.request.contextPath}/comm/email?locale=ko'" class="btn btn-primary"><i class="fa fa-globe" aria-hidden="true"></i> 한국어</button>
								<button type="button" id="locale_en" onclick="parent.location.href='${pageContext.request.contextPath}/comm/email?locale=en'" class="btn btn-default"><i class="fa fa-globe" aria-hidden="true"></i> ENG</button>
								<button type="button" id="locale_zh" onclick="parent.location.href='${pageContext.request.contextPath}/comm/email?locale=zh'" class="btn btn-default"><i class="fa fa-globe" aria-hidden="true"></i> 中国</button>
								<button type="button" id="locale_vn" onclick="parent.location.href='${pageContext.request.contextPath}/comm/email?locale=vn'" class="btn btn-default"><i class="fa fa-globe" aria-hidden="true"></i> Tiếng việt</button>                
							</div></br>
	...
	<div class="modal fade" id="modalContent" tabindex="-2" role="dialog" aria-labelledby="myModal" aria-hidden="true">
	    <div class="modal-dialog" style="width:1000px;">
	        <div class="modal-content">
	            <form name="formContent" id="formContent" method="post" action="${pageContext.request.contextPath}/comm/email_madal" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	function onclickUpdate(action) {
	    ...
	    // 조회
	    $.ajax({
			url:"${pageContext.request.contextPath}/comm/email_modal",
			type:"GET",
	...
	function getDefaultTemplate() {
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/comm/email_origin", 
			type:"GET",
