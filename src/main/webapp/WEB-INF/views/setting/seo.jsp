		...
		<div>
			<div class="box">
				<div class="box-body">
					...
					<form:form name="form_register" method="post" action="${pageContext.request.contextPath }/setting/seo_process?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
						<div class="col-md-6">
