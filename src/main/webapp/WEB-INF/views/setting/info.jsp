		...
		<div>
			<div class="box">
				<div class="box-body">
					...
					<form name="form_register" method="post" action="${pageContext.request.contextPath}/setting/process.do?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
						<div class="col-md-6">
							...
							<table class="table table-bordered">
								...
								<tr>
									...
									<td align="left">
										...
										<button type="button" onclick="winOpen('${pageContext.request.contextPath}/setting/img_view?type=thumb');" class="btn btn-success btn-xs">보기</button> <br> ※ 350 * 285 사이즈로 등록해 주세요 (카카오톡등 메신저 url 노출시 보여지는 이미지 입니다)
								...
								<tr>
									...
									<td align="left">
										...
										<button type="button" onclick="winOpen('${pageContext.request.contextPath}/setting/img_view?type=favicon');" class="btn btn-success btn-xs">보기</button> <br> ※ 16 * 16 사이즈로 등록해 주세요 (확장자 : <span style="color: red">.ico .png</span>)
...
<div class="modal fade" id="modalGuide" tabindex="-2" role="dialog" aria-labelledby="myModal" aria-hidden="true">
	<div class="modal-dialog" style="width: 70%;">
		<div class="modal-content">
			<form name="form_register2" method="post" onsubmit="return false;" action="${pageContext.request.contextPath}/setting/process.do?${_csrf.parameterName}=${_csrf.token}">
...
function setData() {
    // 정보
    $.ajax({
        url:'${pageContext.request.contextPath}/setting/getDeliveryNotice.do',
        type:'post',
        dataType:'json',
        headers: {
