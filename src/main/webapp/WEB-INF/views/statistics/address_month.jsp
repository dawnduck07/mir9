        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form name="form_search" id="form_search" method="post" action="${pageContext.request.contextPath }/statistics/address_month?${_csrf.parameterName}=${_csrf.token}">
						...
						<tr>
							...
							<td align="left">
								...
								<input type="radio" name="statistics_type" id="statistics_type_3" value="yesr" onclick="location.href='${pageContext.request.contextPath}/statistics/address_year'" /> <label for="statistics_type_3">연도별통계</label>
							</td>
						</tr>
						<tr>
