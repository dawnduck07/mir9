			...
			<div class="box">
				<div class="box-body">
					...
					<div class="box-tools " style="margin-bottom: 5px;">
						<form name="form_search" id="form_search" method="post" action="?tpf=admin/statistics/sales_month">
							<table class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td align="left"><input type="text" name="start_date" id="start_date" value="2022-02" class="form-control input-sm txt_date1" style="width: 100px; display: inline-block;" /> ~ <input type="text" name="end_date" id="end_date" value="2022-04" class="form-control input-sm txt_date1" style="width: 100px; display: inline-block;" />
											...
											<button type="button" onclick="setSearchDate('M12');" class="btn btn-primary btn-xs">12개월</button></td>
									</tr>
								</tbody>
								<tfooter>
								<tr>
...
<script>
	dataRow = [ '2022-02', 0, '#76A7FA' ];
	chart_data.push(dataRow);
</script>

<script>
	dataRow = [ '2022-03', 0, '#76A7FA' ];
	chart_data.push(dataRow);
</script>

<script>
	dataRow = [ '2022-04', 0, '#76A7FA' ];
	chart_data.push(dataRow);
</script>
...
<script>
	...
	function setSearchDate(ftype) {
		...
		switch (ftype) {
		case 'D7':
			tm_start_date = '2022-03-09';
			break;
		case 'D15':
			tm_start_date = '2022-03-01';
			break;
		case 'M1':
			tm_start_date = '2022-02-15';
			break;
		case 'M3':
			tm_start_date = '2021-12-15';
			break;
		case 'M6':
			tm_start_date = '2021-09-15';
			break;
		default:
			tm_start_date = '2022-03-15';
		}
