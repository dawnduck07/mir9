				...
				<div class="box">
					<div class="box-body">
						...
						<div class="box-tools pull-right" style="margin-bottom: 5px;">
							<form name="form_search" method="post" action="${pageContext.request.contextPath }/admin/setting/coupon?${_csrf.parameterName}=${_csrf.token}">
							<div class="has-feedback">
								<span> 
									<input type="text" name="keyword" id="keyword" value="${param.keyword == null ? '' : param.keyword }" class="form-control input-sm" placeholder="검색" /> <span class="glyphicon glyphicon-search form-control-feedback"></span>
								</span>
							</div>
						</div>
						<div class="box-tools pull-right" style="margin-bottom: 5px;">
						...
						<form name="form_list" method="post" action="${pageContext.request.contextPath }/admin/coupon/coupon_process?${_csrf.parameterName}=${_csrf.token}">
	...
	<div class="modal fade" id="modalContent" tabindex="-2" role="dialog" aria-labelledby="myModal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="form_register" method="post" action="${pageContext.request.contextPath }/admin/coupon/coupon_process?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td align="left">
									...
									<span style="float: left;"><input type="radio" name="benefitType" value="delivery_free"> 배송비 무료</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left">
									<span style="float: left;"><input type="radio" name="expiryType" value="unlimited"> 무제한</span> <br>
									<br> 
									<span style="float: left;">
										<input type="radio" name="expiryType" value="fix"> 날짜지정
									</span> 
									<span style="float: left; margin-left: 5px;">
										<input type="text" name="expiry_start_date" id="datepicker3" readonly placeholder="시작일" class="form-control input-sm" style="width: 80px">
									</span> 
									<span style="float: left; margin-left: 5px;">&nbsp; ~ &nbsp;</span>
									<span style="float: left;">
										<input type="text" name="expiry_end_date" id="datepicker4" readonly placeholder="종료일" class="form-control input-sm" style="width: 80px">
									</span>
								</td>
							</tr>
							<tr>
...
<script>
	...
	function setData(code) {
		$.ajax({
			url:'${pageContext.request.contextPath}/admin/coupon/getCoupon',
			type:'post',
			dataType:'json',
			headers: {
