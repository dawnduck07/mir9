		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					...
					<form name="form_list" method="post" action="${pageContext.request.contextPath }/admin/map/map_process?${_csrf.parameterName}=${_csrf.token}">
	...
	<div class="modal fade" id="modalRegister" tabindex="-2" role="dialog" aria-labelledby="myModal" aria-hidden="true">
		<div class="modal-dialog" style="width: 600px;">
			<div class="modal-content">
				<form name="form" method="post" action="${pageContext.request.contextPath }/admin/map/map_process?${_csrf.parameterName}=${_csrf.token}">
					<input type="hidden" name="mode" id="mode"> 
...
function setData(mapNo) {
	$.ajax({
		url:'${pageContext.request.contextPath}/admin/map/getMap',
		type:'post',
		dataType:'json',
		headers: {
