									...
									<tr>
					                    ...
					                    <td align="left">
					                    	<span style="float:left;">
					                    		<input type="text" name="delivery_price" value="<fmt:formatNumber value="${deliverySetting.basicDeliveryFee }" pattern="#,###" />" onkeyup="this.value=displayComma(checkNum(this.value))" class="form-control input-sm" style="width:100px; text-align:right;" maxlength="7" />
					                    	</span>
					                    </td>
					                </tr>
					                <tr>
...
<script>
	function register(){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/admin/delivery/updateDeliSet_Doseo",
			method:"get",
			data: {
				jsonStr : jsonStr
			},
