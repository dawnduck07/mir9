	    ...
	    <div class="modal-dialog" style="width:1000px;height:700px;">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
					<form name="form_register" method="post" onsubmit="return false;" action="${pageContext.request.contextPath}/admin/option">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td align="left">
									<ul id="list_option" style="list-style:none;padding-left:0;margin-bottom:0;"></ul>
...
<script>
	...
	function onclickUpdate(optionNo){
		$("#modalContent").modal('show');
		$.ajax({
			url:"${pageContext.request.contextPath}/admin/option/list",
			data: {
				optionNo : optionNo
			},
			headers: {
