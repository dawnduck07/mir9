						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="location.href='${pageContext.request.contextPath}/member/memberWithdrawal.do';">탈퇴</button>
									</div>
									<div class="pull-right">
										<form:form id="memberLogoutFrm" name="memberLogoutFrm" method="POST" action="${pageContext.request.contextPath}/member/memberLogout.do">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li>
								<a href="${pageContext.request.contextPath}/order/log_list">
					...
					<li class="treeview" id="menuManage">
						...
						<ul class="treeview-menu">
							<li>
								<a href="${pageContext.request.contextPath}/menu/menu">
									<i class="fa fa-circle-o"></i> 메뉴 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/head/headList">
									<i class="fa fa-circle-o"></i> 헤더 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/bottom/bottomList">
									<i class="fa fa-circle-o"></i> 하단 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/menu/meta">
					...
					<li class="treeview" id="boardManage">
						...
						<ul class="treeview-menu" id="boardMenu" >
							...
							<li>
								<a href="/mir9/board/listBoard">
									<i class="fa fa-circle-o"></i> 자주하는 질문
								</a>
							</li>
							<li>
								<a href="/mir9/board/listBoard">
									<i class="fa fa-circle-o"></i> 1:1 문의
								</a>
							</li>
							<li>
								<a href="/mir9/board/listBoard">
									<i class="fa fa-circle-o"></i> 테스트
								</a>
							</li>
						</ul>
					</li>
					<li class="treeview" id="productManage">
						...
						<ul class="treeview-menu">
							...
							<li>
								<a href="${pageContext.request.contextPath }/product/category">
									<i class="fa fa-circle-o"></i> 카테고리 
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath }/product/option">
					...
					<li class="treeview" id="memberManage">
						...
						<ul class="treeview-menu">
							...
							<li>
								<a href="${pageContext.request.contextPath}/member/withdrawalList.do">
									<i class="fa fa-circle-o"></i> 탈퇴회원 리스트
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/member/log">
									<i class="fa fa-circle-o"></i> 회원 접속이력 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/member/memberGrade.do">
									<i class="fa fa-circle-o"></i> 등급 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/member/point">
					...
					<li class="treeview" id="formMailManage" >
						...
						<ul class="treeview-menu">
							<li>
								<a href="${pageContext.request.contextPath}/form/manage">
									<i class="fa fa-circle-o"></i> 리스트
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/form/list&form_code=1">
					...
					<li class="treeview" id="statisticsManage">
						...
						<ul class="treeview-menu">
							<li>
								<a href="${pageContext.request.contextPath}/statistics/period_day">
									<i class="fa fa-circle-o"></i> 기간별 매출 통계 
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/statistics/product">
									<i class="fa fa-circle-o"></i> 제품별 매출 통계 
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/statistics/member">
									<i class="fa fa-circle-o"></i> 회원별 매출 통계 
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/statistics/address_day">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="${pageContext.request.contextPath}/comm/email">
									<i class="fa fa-circle-o"></i> 메일 설정
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/comm/email_list">
									<i class="fa fa-circle-o"></i> 메일 발송 내역
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/comm/sms">
									<i class="fa fa-circle-o"></i> SMS 설정
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/comm/sms_list">
									<i class="fa fa-circle-o"></i> SMS 발송 내역
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/comm/review">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="${pageContext.request.contextPath}/setting/point">
									<i class="fa fa-circle-o"></i> 적립금 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/setting/coupon">
									<i class="fa fa-circle-o"></i> 쿠폰 관리
								</a>
							</li>
							<li id="popupManage">
								<a href="${pageContext.request.contextPath}/setting/popup">
									<i class="fa fa-circle-o"></i> 팝업 관리
								</a>
							</li>
							<li id="mapManage">
								<a href="${pageContext.request.contextPath }/setting/map">
									<i class="fa fa-circle-o"></i> 약도 관리
								</a>
							</li>
							<li id="staffManage">
								<a href="${pageContext.request.contextPath}/setting/staff.do">
									<i class="fa fa-circle-o"></i> 임원 관리
								</a>
							</li>
							<li id="historyManage">
								<a href="${pageContext.request.contextPath }/setting/history">
									<i class="fa fa-circle-o"></i> 연혁 관리
								</a>
							</li>
							<li id="bannerManage">
								<a href="${pageContext.request.contextPath}/setting/banner">
									<i class="fa fa-circle-o"></i> 배너 관리
								</a>
							</li>
							<li id="contractManage">
								<a href="${pageContext.request.contextPath}/setting/contract">
									<i class="fa fa-circle-o"></i> 약관 관리
								</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath }/setting/delivery_setting">
									<i class="fa fa-circle-o"></i> 배송 설정
								</a>
							</li>
							<li id="companyManage">
								<a href="${pageContext.request.contextPath }/setting/delivery_company">
									<i class="fa fa-circle-o"></i> 택배사 관리
								</a>
							</li>
							<li id="infoManage">
								<a href="${pageContext.request.contextPath}/setting/info">
									<i class="fa fa-circle-o"></i> 기본 설정
								</a>
							</li>
							<li id="seoManage">
								<a href="${pageContext.request.contextPath}/setting/seo">
									<i class="fa fa-circle-o"></i> SEO 설정
								</a>
							</li>
							<li id="paymentManage">
								<a href="${pageContext.request.contextPath}/setting/paymentpg">
									<i class="fa fa-circle-o"></i> 결제PG 설정
								</a>
							</li>
							<li id="snsManage">
								<a href="${pageContext.request.contextPath}/setting/snslogin">
									<i class="fa fa-circle-o"></i> SNS 연동 설정
								</a>
							</li>
							<li id="localeManage">
								<a href="${pageContext.request.contextPath}/setting/locale">
					...
					<li>
						<a href="${pageContext.request.contextPath}/setting/version"> 
